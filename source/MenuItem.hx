...
class MenuItem extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, weekNum:Int = 0)
	{
		...
		week.frames = tex;
		// TUTORIAL IS WEEK 0
		week.animation.addByPrefix('week0', 'Week 6', 24);
		week.animation.addByPrefix('week1', "Week 4 press", 24);
		week.animation.addByPrefix('week2', "week2 select", 24);
		week.animation.addByPrefix('week3', "Week 3 press", 24);
		week.animation.addByPrefix('week4', "WEEK1 select", 24);
		week.animation.addByPrefix('week5', "week 5", 24);
		week.animation.addByPrefix('week6', "tutorial selectedWeek 6", 24);
		add(week);
